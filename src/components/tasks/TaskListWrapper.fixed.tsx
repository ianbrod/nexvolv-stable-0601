...
import { Task, Goal as PrismaGoal, TaskPriority, TaskStatus } from '@prisma/client'; // Import Prisma types
...
export function TaskListWrapper({
  ...
  }, [filteredTasks, isSelectMode, selectedTasks, getGoalName, handleEdit, handleDeleteConfirm, onTaskClick, useVirtualization, handleTaskSelect, handleKeyDown]);
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {!hideSearchAndFilters && (
        <div className="flex-shrink-0 bg-background pt-2 pb-4 border-b mb-6">
          {/* Search Bar */}
          <div className="mb-4">
            <SearchBar
      ...
      <div className="flex-shrink-0 flex justify-between items-center mb-4">
        {/* Removed 'Tasks' heading as requested */}
      ...
      <div
        className="flex-grow overflow-auto h-full min-h-[300px]" /* Add min-height to ensure there's space for the list */
        ref={containerRef}
